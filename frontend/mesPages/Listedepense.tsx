...
import { FlatList,View,Text,StyleSheet,TouchableOpacity, ScrollView, KeyboardAvoidingView,ActivityIndicator} from 'react-native';
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      try {
        ...
        const expensesData: DocumentData[] = expensesSnapshot.docs.map(doc => doc.data());
